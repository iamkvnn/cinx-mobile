...
public class PaginatedApiResponseQuizSessionResponse {
    ...
    private List<QuizSessionResponse> data;
    public List<QuizSessionResponse> getData() { return data; }
    public void setData(List<QuizSessionResponse> val) { this.data = val; }
