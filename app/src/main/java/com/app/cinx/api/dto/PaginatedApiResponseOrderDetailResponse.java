...
public class PaginatedApiResponseOrderDetailResponse {
    ...
    public List<OrderDetailResponse> getData() { return data; }
    public void setData(List<OrderDetailResponse> val) { this.data = val; }
